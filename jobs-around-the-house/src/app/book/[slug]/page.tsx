...
export default async function BookPage({ params }: BookPageProps) {
        ...
        <main id="main-content">
          <section className="page-header">
            <div className="container">
              <h1 className="page-header__title">Service Not Found</h1>
              <p className="page-header__subtitle">
                Sorry, we couldn&apos;t find that service. Please browse our available
                services below.
              </p>
            </div>
          </section>
  ...
  const singleBgUrl = !hasCarousel && product.imageUrl ? product.imageUrl : undefined;
    ...
    <>
      ...
      <main id="main-content">
        <section 
          ...
          style={singleBgUrl ? { backgroundImage: `url('${singleBgUrl}')` } : undefined}
        >
          ...
          <div className="container" style={{ position: "relative", zIndex: 10 }}>
            ...
            <p className="page-header__subtitle">{product.description}</p>
          </div>
        </section>

        <section className="section booking-section">
          <div className="container">
            <BookingWizard product={productData} workflow={workflowData} />
          </div>
        </section>
      </main>
      <Footer />
