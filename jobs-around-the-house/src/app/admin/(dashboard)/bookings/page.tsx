  ...
  return (
    <div className="admin-page">
      <div className="admin-page__header">
        ...
        <p className="admin-page__subtitle">{bookings.length} total bookings</p>
      </div>

      {bookings.length === 0 ? (
        <div className="admin-empty">
          <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" style={{ color: "var(--color-gray-300)", marginBottom: "var(--space-4)" }}>
                ...
                <tr key={booking.id}>
                  ...
                  <td>
                    <span
                      ...
                      style={{
                        background: booking.paymentStatus === "paid" ? "#10b98115" : "#f59e0b15",
