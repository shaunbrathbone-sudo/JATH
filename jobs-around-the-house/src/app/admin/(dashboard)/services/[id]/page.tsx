...
export default async function AdminProductPage({ params }: Props) {
    ...
    // Fetch all categories to allow assigning categories
        ...
        <div className="admin-page">
            <div className="admin-page__header">
                ...
                <p className="admin-page__subtitle">
                    Modify the base pricing parameters, inventory tracking, VAT
                    rates, and general settings for {product.title}.
                </p>
