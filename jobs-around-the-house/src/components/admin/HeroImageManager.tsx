...
const HeroImageManager = ({ categories }: HeroImageManagerProps) => {
        ...
        try {
            ...
            if (res.ok) {
                setMessage({
                    ...
                    text:
                        url ?
                            "Header background set successfully!"
                        :   "Background cleared (using default active image).",
                    type: "success",
                });
                router.refresh();
            } else {
                ...
                setMessage({
                    id: categoryId,
                    text: data.error || "Failed to update background",
                    type: "error",
                });
            }
        } catch {
    ...
    const getSelectedBgUrl = (cat: Category) => {
        return (
            cat.imageUrl ||
            cat.heroImages.find((img) => img.isActive)?.imageUrl ||
            ""
        );
    };
                            ...
                            <div className="hero-manager__header">
                                <div>
                                    ...
                                    <p className="hero-manager__slug">
                                        {cat.heroImages.length}/6 images
                                        uploaded
                                        {cat.imageUrl ?
                                            " · Custom Header Bg Set"
                                        :   ""}
                                    </p>
                                </div>
                            </div>
                                            ...
                                            >
                                                ...
                                                <div className="hero-manager__thumb-controls">
                                                    ...
                                                    <button
                                                        ...
                                                        title={
                                                            isBg ?
                                                                "Remove as category header background"
                                                            :   "Set as category header background"
                                                        }
                                                    >
                                                        <svg
                                                            width="14"
