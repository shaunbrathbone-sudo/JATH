        ...
        <div className="pricing-editor">
                ...
                >
                    ...
                    <div className="pricing-editor__grid">
                        {vars.map((v) => (
                            <div
                                key={v.key}
                                className="pricing-editor__item"
                            >
                                <div className="pricing-editor__info">
                                    ...
                                    {v.description && (
                                        <p className="pricing-editor__desc">
                                            {v.description}
                                        </p>
                                    )}
                                </div>
                                <div className="pricing-editor__input-group">
                                    <input
                                        ...
                                        step={
                                            v.unit === "multiplier" ? 0.01 : 1
                                        }
                                    />
                                    {v.unit && (
                                        <span className="pricing-editor__unit">
                                            {v.unit}
                                        </span>
                                    )}
                                </div>
            ...
            {hasChanges && (
                <div className="pricing-editor__actions">
                    ...
                    {saved && (
                        <span className="pricing-editor__saved">
                            ✓ Changes saved
                        </span>
                    )}
                </div>
