# Jobs Around The House — Agent Rules

This is the central rules file for the **jobs-around-the-house** workspace.
...
This repository is a **Next.js** application for the Jobs Around The House platform.

It contains:

- **Skills** (`.agents/skills/`) — specialised agent instructions for SEO audits, React patterns, endpoint management, animations, and more.
...
7. **Implementation plan before code** — never write code until the user has reviewed and explicitly approved the implementation plan. Always present the plan first, wait for approval, then execute.
...
- 2026-07-14 — Created this AGENTS.md as the single source of truth for project-scoped agent rules.
